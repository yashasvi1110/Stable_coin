...
const createAndMintToken = async () => {
  ...
  try {
    ...
    // Wait a moment for the account to be fully initialized
    console.log('\n⏳ Waiting for account initialization...');
    await new Promise(resolve => setTimeout(resolve, 2000));
    
    // Mint initial supply using direct SPL token instruction
    ...
    const mintInstruction = {
      ...
      keys: [
        ...
        { pubkey: mintSigner.publicKey, isSigner: true, isWritable: false },
      ],
    ...
    const tokenInfo = {
      ...
      mintTransaction: mintTx.toString(),
